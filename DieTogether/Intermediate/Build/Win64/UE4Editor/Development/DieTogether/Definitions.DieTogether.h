#undef DIETOGETHER_API
#undef DIETOGETHER_VTABLE
...
#define UE_PROJECT_NAME DieTogether
...
#define DIETOGETHER_VTABLE DLLEXPORT_VTABLE
#define DIETOGETHER_API DLLEXPORT
#define PAPER2D_VTABLE DLLIMPORT_VTABLE
